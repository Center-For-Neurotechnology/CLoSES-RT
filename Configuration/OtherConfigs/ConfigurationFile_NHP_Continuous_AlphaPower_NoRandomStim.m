function [sCoreParams, variantConfig] = ConfigurationFile_NHP_Continuous_AlphaPower_NoRandomStim(sCoreParams, variantConfig)
...
%Control Stimulation
sCoreParams.decoders.chanceDetector.useChanceDetector = 0;      % Whether to use a Random (Sham) Detector
...
sCoreParams.decoders.txDetector.ProbabilityOfStim = 0.75;       % Given a detected event, what is the proba of actually sending a stimulation pulse
...
sCoreParams.stimulator.startupTimeSec = 20;     % Wait in seconds before allowing stimulation
