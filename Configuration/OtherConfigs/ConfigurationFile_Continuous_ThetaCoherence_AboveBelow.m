function [sCoreParams, variantConfig] = ConfigurationFile_Continuous_ThetaCoherence_AboveBelow(sCoreParams, variantConfig)
...
% - sCoreParams.decoders.txDetector.txRMSLower = 5.67;              % 1/Times below Threshold when detection occurs
