function [sCoreParams, variantConfig] = ConfigurationFile_Continuous_Sleep_ThUpdateAfterStim(sCoreParams, variantConfig)
...
% relative to a baseline that is computed after 5 stimulations or every 1 minute without stim.
%
...
%
% Default for  CONTINUOUS default (No Task) with baseline based threshold re-computed after 5 stimulations or after 1 minute without stim
%
...
% - triggerType = 'FOLLOWSTIMORFIXED';        % Options: EEGDATA / FIXEDPERIOD / FOLLOWINGSTIM / FOLLOWSTIMORFIXED
%
