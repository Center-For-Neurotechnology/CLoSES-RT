function [sCoreParams, variantConfig] = ConfigurationFile_Continuous_GammaPower(sCoreParams, variantConfig)
% This file contains the specific configuration for an experiment 
%
% This configuration is to trigger stimulation when power in Gamma band *increases*
% relative to a baseline that is computed every .
%
...
% - sCoreParams.decoders.txDetector.nDetectionsRequested = 25;   % How many consecutive detection needed for stimulation
...
%
% Variant Selection:
% - freqBandName = 'HIGHGAMMA';         % Options: THETA (4-8) / ALPHA (8-15) / BETA (15-30) / LOWGAMMA (30-55) / HIGHGAMMA (65-110) / HIGHGAMMARIPPLE (65-200) / RIPPLE (140-200) / GAMMA (30-110) /SPINDLES (12-16) / NOFILTER
...
%Power Window
sCoreParams.Features.Data.SmoothWindowsDurationSamples = 50;
