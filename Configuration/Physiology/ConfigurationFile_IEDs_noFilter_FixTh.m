function [sCoreParams, variantConfig] = ConfigurationFile_IEDs_noFilter_FixTh(sCoreParams, variantConfig)
...
freqBandName = 'NOFILTER';         % Options: THETA / ALPHA / BETA / LOWGAMMA / HIGHGAMMA / HIGHGAMMARIPPLE / RIPPLE
featureName =  'SMOOTHBANDPOWER';    % Options: SMOOTHBANDPOWER / VARIANCEOFPOWER / COHERENCE 

% Power
sCoreParams.Features.Data.SmoothWindowsDurationSamples = 20;%100; %window to make power smooth -> ot should be short to avoid delay!
...
sCoreParams.decoders.txDetector.nDetectionsRequestedmSec = 10;   % duration in ms of consecutive detections required to produce a stiulation (idea of only detecting if feature is large for a certain duration)
