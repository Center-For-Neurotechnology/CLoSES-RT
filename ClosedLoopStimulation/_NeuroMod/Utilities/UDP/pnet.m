...
%
%  sock=pnet('udpsocket',port,'my_ip_addr');
%
%     Creates a UDP socket and binds it to an UDP port using network IP
%     'my_ip_addr', such as '192.168.30.1'. On this socket can you
%     recive UDP packets destinated to this UDP port, and send UDP packets with
%     this sockat as source adress. Returns -1 on fail or a handler >=0 on
